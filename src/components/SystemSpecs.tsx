...
export default function SystemSpecs({ specs, onChange, onSubmit, dirty, cpuList, gpuList, detecting, unmatchedFields = [] }: Props) {
    ...
    <div className="card bg-base-100 shadow-sm">
      <div className="card-body">
        ...
        {!detecting && unmatchedFields.length > 0 && (
          <div role="alert" className="alert border-warning/30 bg-warning/10 text-sm">
